...
<html >
  <head>
    <meta charset="UTF-8">
    <title>VirtuOps<sup><span style="font-size: 10px;">&reg;</span></sup> Commander Invalid License</title>
  ...
  <body>
    ...
    exit();
        ...
        <html >
          <head>
            <meta charset="UTF-8">
            <title>VirtuOps<sup><span style="font-size: 10px;">&reg;</span></sup> Commander License Expired</title>
                <link rel="stylesheet" href="libs/css/login.css">
                <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
          </head>
...
<html >
  <head>
    <meta charset="UTF-8">
    <title>VirtuOps&reg; Commander Login</title>
        <link rel="stylesheet" href="libs/css/login.css">
        <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
  </head>
...
<html >
  ...
  <body>
    <div class="wrapper">
        <div class="container">
                <h1>VirtuOps<sup><span style="font-size: 10px;">&reg;</span></sup> Commander</h1>
