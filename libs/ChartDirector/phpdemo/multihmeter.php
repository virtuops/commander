...
$textBoxObj = $m->addText(148, 70, $m->formatValue($value0, "2"), "arial.ttf", 8, 0x6666ff,
    BottomRight);
$textBoxObj->setBackground(0, 0, -1);
$textBoxObj = $m->addText(193, 70, $m->formatValue($value1, "2"), "arial.ttf", 8, 0x33ff33,
    BottomRight);
$textBoxObj->setBackground(0, 0, -1);
$textBoxObj = $m->addText(238, 70, $m->formatValue($value2, "2"), "arial.ttf", 8, 0xff3333,
    BottomRight);
$textBoxObj->setBackground(0, 0, -1);
