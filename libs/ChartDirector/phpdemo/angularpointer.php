...
$pointerObj = $m->addPointer(9, 0x7fff6666, 0xff6666);
$pointerObj->setShape(ArrowPointer2);

# Add a semi-transparent yellow (0x7fffff66) pointer using another arrow shape
$pointerObj = $m->addPointer(51, 0x7fffff66, 0xffff66);
$pointerObj->setShape(ArrowPointer);

# Add a semi-transparent green (0x7f66ff66) pointer using the line shape
$pointerObj = $m->addPointer(72, 0x7f66ff66, 0x66ff66);
$pointerObj->setShape(LinePointer);

# Add a semi-transparent grey (0x7fcccccc) pointer using the pencil shape
$pointerObj = $m->addPointer(85, 0x7fcccccc, 0xcccccc);
$pointerObj->setShape(PencilPointer);
