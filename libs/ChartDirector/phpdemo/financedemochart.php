...
function getData($ticker, $startDate, $endDate, $durationInDays, $extraPoints) {
    ...
    if ($durationInDays <= 10) {
        ...
        $adjustedStartDate = $startDate - fmod2($startDate, 86400) - (int)($extraPoints /
        ...
        $adjustedStartDate = $startDate - fmod2($startDate, 86400) - (int)(($extraPoints * 7 + 4) /
            5) * 86400 - 2 * 86400;
...
function drawChart() {
    ...
    while ((fmod2($endDate, 86400) < 9 * 3600 + 30 * 60) || (getChartWeekDay($endDate) == 0) || (
    ...
    if ($resolution < 86400) {
        ...
        $extraTrailingPoints = (int)((16 * 3600 - fmod2($lastTime, 86400)) / $resolution);
