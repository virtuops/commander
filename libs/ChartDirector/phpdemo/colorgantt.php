...
$startDate = array(chartTime(2004, 8, 16), chartTime(2004, 10, 4), chartTime(2004, 8, 30),
    chartTime(2004, 9, 13), chartTime(2004, 9, 20), chartTime(2004, 9, 27), chartTime(2004, 10, 4),
    chartTime(2004, 10, 4), chartTime(2004, 10, 25), chartTime(2004, 11, 1), chartTime(2004, 10, 18
    ), chartTime(2004, 11, 8));
$endDate = array(chartTime(2004, 8, 30), chartTime(2004, 10, 18), chartTime(2004, 9, 13), chartTime(
    2004, 9, 27), chartTime(2004, 10, 4), chartTime(2004, 10, 11), chartTime(2004, 11, 8),
    chartTime(2004, 10, 18), chartTime(2004, 11, 8), chartTime(2004, 11, 22), chartTime(2004, 11, 1
...
$textBoxObj = $c->addTitle("Mutli-Color Gantt Chart Demo", "timesbi.ttf", 15, 0xffffff);
...
$c->addScatterLayer(array(1), array(chartTime(2004, 9, 13)), "Milestone 1", Cross2Shape(), 13,
    0xffff00);
$c->addScatterLayer(array(3), array(chartTime(2004, 10, 4)), "Milestone 2", StarShape(5), 15,
    0xff00ff);
$c->addScatterLayer(array(5), array(chartTime(2004, 11, 8)), "Milestone 3", TriangleSymbol, 13,
    0xff9933);
