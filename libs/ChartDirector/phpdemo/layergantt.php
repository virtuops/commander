...
$textBoxObj = $c->addTitle("Multi-Layer Gantt Chart Demo", "timesbi.ttf", 15, 0xffffff);
$textBoxObj->setBackground(0x006000);
...
$actualColor = $c->patternColor(array(0xffffff, 0xffffff, 0xffffff, 0xff0000, 0xffffff, 0xffffff,
    0xff0000, 0xffffff, 0xffffff, 0xff0000, 0xffffff, 0xffffff, 0xff0000, 0xffffff, 0xffffff,
    0xffffff), 4);
...
$boxLayerObj = $c->addBoxLayer($startDate, $endDate, $plannedColor, "Planned");
