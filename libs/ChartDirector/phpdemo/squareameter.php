...
if ($chartIndex == 0) {
    ...
    $textBoxObj = $m->addText(103, 7, $m->formatValue($value, "2"), "arial.ttf", 8, 0xffffff,
        TopRight);
    ...
    $textBoxObj = $m->addText(103, 103, $m->formatValue($value, "2"), "arial.ttf", 8, 0xffffff,
        BottomRight);
    $textBoxObj->setBackground(0, 0, -1);
    ...
    $textBoxObj = $m->addText(7, 103, $m->formatValue($value, "2"), "arial.ttf", 8, 0xffffff,
        BottomLeft);
    $textBoxObj->setBackground(0, 0, -1);
} else {
    ...
    $textBoxObj = $m->addText(7, 7, $m->formatValue($value, "2"), "arial.ttf", 8, 0xffffff, TopLeft)
        ;
    $textBoxObj->setBackground(0, 0, -1);
}
