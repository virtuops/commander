...
$scatterLayerObj = $c->addScatterLayer($dataX0, $dataY0, "Technology AAA", GlassSphereShape, 15,
    0xff3333);
...
$scatterLayerObj = $c->addScatterLayer($dataX1, $dataY1, "Technology BBB", GlassSphereShape, 15,
    0x0000ff);
