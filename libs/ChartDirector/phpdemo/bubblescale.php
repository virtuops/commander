...
$scatterLayerObj = $c->addScatterLayer($dataX0, $dataY0, "", CircleSymbol, 9, 0x80ff3333, 0x80ff3333
    );
...
$scatterLayerObj = $c->addScatterLayer($dataX1, $dataY1, "", SquareSymbol, 9, 0x803333ff, 0x803333ff
    );
...
$scatterLayerObj = $c->addScatterLayer($dataX2, $dataY2, "", DiamondSymbol, 9, 0x8033ff33,
    0x8033ff33);
