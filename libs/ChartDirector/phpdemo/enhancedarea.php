...
$drawAreaObj = $c->getDrawArea();
$contentBox->setSize($drawAreaObj->getWidth() - 1 - $frameWidth * 2, $drawAreaObj->getHeight() -
...
$textBoxObj = $c->addText($plotArea->getLeftX() + $plotArea->getWidth() - 5, $plotArea->getTopY() +
