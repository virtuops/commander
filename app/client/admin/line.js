      ...
      line: {
		...
		toolbar: {
		  ...
		  onClick: function (event) {
		    ...
		    if (event.target == 'save') {
		      ...
		      record.chartlinecolor = typeof record.chartlinecolor_multi !== "undefined" ? record.chartlinecolor_multi : record.chartlinecolor_single;
		      ...
		      if (record.chartlinelabels instanceof Object) {
			  record.chartlinelabels = record.chartlinelabels.id
		      }
		      if (record.chartlineeffect instanceof Object) {
			  record.chartlineeffect = record.chartlineeffect.id
		      }
		...
		onRender: function(event){
			  event.onComplete = function(){
				  ...
				  getToolMenus(w2ui.viewobjectform_line, w2ui.viewobjectform_line.fields[2]);
				  getViewMenus(w2ui.viewobjectform_line, w2ui.viewobjectform_line.fields[3]);
			  }
		},
		fields: [
		  ...
		  { name: 'viewmenu',  type: 'list', required: true, options: { items: [] }, html: { caption: 'Tool Bar', attr: 'size="40" maxlength="40"' }},
		  ...
		  { name: 'chartlinecolor_single', type: 'color', required: false, html: { caption: 'Chart Title BG Color', attr: 'size="80" maxlength="80"' } },
		  { name: 'chartlinecolor_multi', type: 'text', required: false, html: { caption: 'Chart Title BG Color', attr: 'size="80" maxlength="80"' } },
